...
resource "google_iam_workload_identity_pool_provider" "github_provider" {
  ...
  attribute_condition = "assertion.repository == \"${var.github_owner}/${var.repo_name}\""
}
...
resource "google_service_account_iam_binding" "workload_identity_bindings" {
  ...
  members = [
    "principalSet://iam.googleapis.com/projects/${var.project_id}/locations/global/workloadIdentityPools/${var.wip_id}/attribute.repository/${var.github_owner}/${var.repo_name}"
  ]
}
